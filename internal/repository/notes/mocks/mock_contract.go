...
// Source: github.com/Mafit1/notes-app/internal/repository/notes (interfaces: Repository)
...
func (m *MockRepository) GetAll(arg0 context.Context) ([]models.Note, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepository) GetByID(arg0 context.Context, arg1 int64) (models.Note, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepository) Update(arg0 context.Context, arg1 models.Note) (models.Note, error) {
	m.ctrl.T.Helper()
